                        ...
                        CustomExpansionTile(
                          ...
                          children: [
                            CustomFormField(
                              ...
                              controller:
                                  profileTabController.emailController.value,
                            ),
                            CustomFormField(
                              title: "Full Name",
                              hint: "William Bennett",
                              controller:
                                  profileTabController.fullNameController.value,
                            ),
                            CustomFormField(
                              title: "Street Address",
                              hint: "465 Nolan Causeway Suite 079",
                              controller: profileTabController
                                  .streetAddressController.value,
                            ),
                            CustomFormField(
                              title: "Apt, Suite, Bldg (optional)",
                              hint: "Unit 512",
                              controller: profileTabController
                                  .aptSuiteBldgController.value,
                            ),
                            CustomFormField(
                              title: "Zip Code",
                              hint: "77017",
                              controller:
                                  profileTabController.zipCodeController.value,
                            ),
                            Padding(
